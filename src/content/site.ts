export const testimonials = [
  {
    quote:
      'Seamless Teterboro departure and an attentive crew from wheels-up to wheels-down. Exactly the experience we needed for a time-sensitive meeting.',
    name: 'Michael R.',
    role: 'Executive traveler',
  },
  {
    quote:
      'Professional coordination, clear pricing, and a comfortable cabin. We charter regularly and this team is consistently reliable.',
    name: 'Sarah K.',
    role: 'Corporate client',
  },
  {
    quote:
      'Last-minute itinerary changes were handled without stress. Communication was excellent at every step.',
    name: 'David L.',
    role: 'Family charter',
  },
  {
    quote:
      'Aircraft was immaculate and the flight crew was outstanding. FBO support at Teterboro made the whole trip effortless.',
    name: 'Jennifer M.',
    role: 'Private client',
  },
  {
    quote:
      'From quote to landing, everything felt premium but straightforward. We will book again for our northeast routes.',
    name: 'Robert T.',
    role: 'Repeat charter',
  },
  {
    quote:
      'Discreet, punctual, and polished. The kind of service you expect when your schedule cannot afford delays.',
    name: 'Amanda C.',
    role: 'VIP traveler',
  },
] as const
