      ...
      <div className="mx-auto max-w-7xl px-8">
        <div className="grid gap-12 lg:grid-cols-12 lg:gap-16">
          <div className="lg:col-span-4">
            ...
            <p className="mt-5 text-base text-white/60">Got questions? We&apos;ve got answers!</p>
          </div>
            ...
            {faqs.map((item, i) => {
              ...
              return (
                <li key={item.q} className="border-b border-white/15">
                  ...
                  {isOpen && (
                    <p className="pb-6 text-sm leading-relaxed text-white/60 md:text-base">{item.a}</p>
                  )}
                </li>
              )
            })}
